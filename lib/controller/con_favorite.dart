...
Future<List<ModelEbook>> fetchFavorite(List<ModelEbook> ebook, String id) async{
  var request = await Dio().get(ApiConstant().baseUrl+ApiConstant().api+ApiConstant().favorite+id);
