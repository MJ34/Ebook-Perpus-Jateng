...
Future<List<ModelEbook>> fetchDetail(List<ModelEbook> ebook, int id) async{
  var request = await Dio().get(ApiConstant().baseUrl+ApiConstant().api+ApiConstant().detail+id.toString());
